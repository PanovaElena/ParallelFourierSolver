...
class TestStandingWave :public testing::Test, public StandingWave {
public:
...
TEST_F(TestStandingWave, other_components_is_null_Ey_Bz) {
    MyTestBodyCheckOnNull();
}

TEST_F(TestStandingWave, res_is_sinus_Ey_Bz) {
    MyTestBodyWriteFile();
}