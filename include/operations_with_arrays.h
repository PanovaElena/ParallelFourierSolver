...
public:
    ...
    static void WriteDouble(Grid3d& gr, Field _field, Coordinate _coord, Direction direction, Array3d<double>& arr);
    static void WriteComplex(Grid3d& gr, Field _field, Coordinate _coord, Direction direction, Array3d<MyComplex>& arr);
